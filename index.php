...
<body>
  <div class="wrapper">
    <form action="#" autocomplete="off">
      <input type="text" spellcheck="false" name="full_url" placeholder="Your URL" required>
        ...
        <div class="urls-area">
          ...
          <?php
            while($row = mysqli_fetch_assoc($sql2)){
              ?>
              <div class="data">
                <li><?php echo $domain.$row['shorten_url']; ?> </li> 
                <li><?php echo $row['full_url'];?></li> 
                <li><?php echo $row['clicks'] ?></li>
                <li><a href="php/delete.php?id=<?php echo $row['shorten_url'] ?>">Delete</a></li>
                <li><img src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=<?php echo $domain.$row['shorten_url']; ?>" title="Link to my Website" /></li>
              </div>
              <?php
            }
          ?>
